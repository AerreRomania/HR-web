...
$(document).ready(function () {
    ...
    function doOnOrientationChange() {
        $(".iframe_load").css("height", '100vh');
        $(".iframe_load").css("width", $(window).prop('scrollHeight'));
        //if (screen.height > screen.width) {
        //    $(".iframe_load").each(function () {
        //        $(".iframe_load").css("height", $(window).height());
        //        $(".iframe_load").css("width", $(window).width());
...
///////////////////////////////
    ...
    function doSomething() {
        $('.nekaKlasa2').click(function () {
            ...
            var iframe_elem = '<div style="overflow:auto;-webkit-overflow-scrolling:touch"><iframe src=" ' + link + ' "class="iframe_load"  frameBorder="0" style="overflow:hidden;width:100%;height:950px;" width="100%" height="950px;" ></iframe></div>';
