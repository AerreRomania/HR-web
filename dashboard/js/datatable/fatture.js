var TableDatatablesButtons = function() {
	...
	var initTable1 = function() {
		...
		var oTable = table.dataTable({
			...
			// "search": "Cerca:",
			// "zeroRecords": "Non sono stati trovati dei risultati corrispondenti"
			// },
	...
	var initAjaxDatatables = function() {
		...
		grid.init({
			...
			dataTable : { // here you can define a typical datatable settings from http://datatables.net/usage/options
				...
				// Uncomment below line("dom" parameter) to fix the dropdown overflow issue in the datatable cells. The default datatable layout
				// setup uses scrollable div(table-scrollable) with overflow:auto to enable vertical scroll(see: assets/global/js/Scripts/datatable.js).
				// So when dropdowns used the scrollable div should be removed.
				...
				"order" : [ [ 2, "desc" ] ],// set first column as a default sort by asc
