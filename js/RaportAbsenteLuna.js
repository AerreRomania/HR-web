// RaportAbsenteLuna.js
function Lista()  
{
    $get('up').style.display = '';
    WbmOlimpias.RaportAbsenteLunaWS.RaportAbsenteLunaLista($get("ddlFiltruAn").value, $get("ddlFiltruLuna").value, SucceededCallback, FailedCallback);
}

function bExcel_Click() {
    $get('up').style.display = '';
    WbmOlimpias.RaportAbsenteLunaWS.RaportAbsenteLunaExcel($get("ddlFiltruAn").value, $get("ddlFiltruLuna").value, SucceededCallback, FailedCallback);
}
