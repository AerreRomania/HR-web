	...
	/* options	
		{
			...
			mimeType: ("application/pdf<default>"|"Images/Image/svg+xml"),
	...
	*/
    ...
    <SOAP-ENV:Body> \
        <fairy:format SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"> \
            ...
            jQuery.ajax({
                type: "POST",
                url: current_mimetype == "Images/Image/png" || current_mimetype == "Images/Image/jpg" || current_mimetype == "Images/Image/gif" ? xepOnline.Formatter.xep_chandra_service_page_images : xepOnline.Formatter.xep_chandra_service,
                processData: false,
                contentType: false,
                data: blob,
                success: current_mimetype == "Images/Image/png" || current_mimetype == "Images/Image/jpg" || current_mimetype == "Images/Image/gif" ? xepOnline.Formatter.__processImages : xepOnline.Formatter.__postBackSuccess,
    ...
    __postBackSuccess: function (Response) {
        ...
        if (current_mimetype == 'Images/Image/svg+xml') {
            if (jQuery(xepOnline.Formatter.__container).attr('data-xeponline-embed-pending') === 'true') {
    ...
    __processImages: function (Response) {
        ...
        if (jQuery(xepOnline.Formatter.__container).attr('data-xeponline-embed-pending') === 'true') {
            ...
            jQuery.each(Pages, function (index, value) {
                jQuery(xepOnline.Formatter.__elm).append('<img style="border:1px solid black" height="100%" src="data:Images/Image/png;base64,' + jQuery(value).text() + '"/>');
            });
        }
        else {
