    ...
    <form id="form1"   runat="server" >
        <asp:ScriptManager runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="dashboard/js/main_controler5.4.js" />
...
<button class="submit" id="msg_submit">Send</button>
         ...
         <div class="container " >
            ...
            <div class="container-fluid">
                <div class="tab">
                    ...
                    <div class="tab_content">
                       ...
                       <%--     <asp:Label runat="server">Loading...</asp:Label>
                            <video controls="controls" muted="muted" autoplay="autoplay"  loop="loop" id="vid" style="height: 90vh; width: 100%;">
                                <source src="./Images/Video/test.mp4" type="Images/Video/mp4" />
                            </video>--%>
                            <div class="loader">
            ...
            <div id="lvl_two_riso_scheda_dipedenti" class="animated fadeIn">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Scheda Dipendente" data-link="./Views/HR/form-scheda-new.aspx" data-img="./dashboard/images/riso-scheda-dipedente.png" runat="server" id="bm_riso_scheda_dipedente">★</div>
                    </div>
                    <article id="riso_scheda_dip" class="nekaKlasa" data-name="Scheda Dipendente" data-link="./Views/HR/form-scheda-new.aspx" runat="server">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior blur" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Efficienze" data-link="./#!" data-img="" runat="server" id="Div1">★</div>
                    </div>
                    <article id="Article8" class="nekaKlasa" data-name="Efficienze" data-link="./#!" runat="server">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior blur" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Buste paga" data-link="./#!" data-img="./dashboard/images/riso-buste-paga.png" runat="server" id="Div4">★</div>
                    </div>
                    <article id="Article10" class="nekaKlasa" data-name="Buste paga" data-link="./#!" runat="server">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior blur" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Ferie / Previdenza" data-link="./#!" data-img="./dashboard/images/riso-ferie.png" runat="server" id="Div5">★</div>
                    </div>
                    <article id="Article11" class="nekaKlasa" data-name="Ferie / Previdenza" data-link="./#!" runat="server">
            ...
            <div id="lvl_three_riso_statistiche_tessitura" class="animated fadeIn">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Tessitura" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=TESSITURA" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div18">★</div>
                    </div>
                    <article id="riso_stat_tess_ass" class="nekaKlasa" data-name="Assenteismo Tessitura" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=TESSITURA" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Mensile Tessitura" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Tessitura" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div60">★</div>
                    </div>
                    <article id="Article2" class="nekaKlasa" data-name="Assenteismo Mensile Tessitura" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Tessitura" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Straordinario Tessitura" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=TESSITURA" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div19">★</div>
                    </div>
                    <article id="riso_stat_tess_stra" class="nekaKlasa" data-name="Straordinario Tessitura" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=TESSITURA" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
            ...
            <div id="lvl_three_riso_statistiche_confezione" class="animated fadeIn">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Confezione A - Assenteismo" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=CONFEZIONE%20A" data-img="./dashboard/images/riso-stat-confezione.png" runat="server" id="Div21">★</div>
                    </div>
                    <article id="riso_confa_ass" class="nekaKlasa" data-name="Confezione A - Assenteismo" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=CONFEZIONE%20A" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-confezione.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Mensile Confezione A" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Confezione%20A" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div61">★</div>
                    </div>
                    <article id="Article6" class="nekaKlasa" data-name="Assenteismo Mensile Confezione A" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Confezione%20A" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Confezione A - Straordinario" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=CONFEZIONE%20A" data-img="./dashboard/images/riso-stat-confezione.png" runat="server" id="Div22">★</div>
                    </div>
                    <article id="riso_confa_stra" class="nekaKlasa" data-name="Confezione A - Straordinario" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=CONFEZIONE%20A" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-confezione.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Confezione B - Assenteismo" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=CONFEZIONE%20B" data-img="./dashboard/images/riso-stat-confezione.png" runat="server" id="Div48">★</div>
                    </div>
                    <article id="riso_confb_ass" class="nekaKlasa" data-name="Confezione B - Assenteismo" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=CONFEZIONE%20B" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-confezione.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Mensile Confezione B" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Confezione%20B" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div62">★</div>
                    </div>
                    <article id="Article16" class="nekaKlasa" data-name="Assenteismo Mensile Confezione B" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Confezione%20B" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Confezione B - Straordinario" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=CONFEZIONE%20B" data-img="./dashboard/images/riso-stat-confezione.png" runat="server" id="Div49">★</div>
                    </div>
                    <article id="riso_stat_confb_stra" class="nekaKlasa" data-name="Confezione B - Straordinario" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=CONFEZIONE%20B" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-confezione.png');"></a>
                        <div class="article-lpurple">
                            <h2>
            ...
            <div id="lvl_three_riso_statistiche_stiro" class="animated fadeIn">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior " runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Stiro" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=STIRO" data-img="./dashboard/images/riso-stat-stiro.png" runat="server" id="Div29">★</div>
                    </div>
                    <article id="riso_stat_stiro_assenteismo" class="nekaKlasa" data-name="Assenteismo Stiro" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=STIRO" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-stiro.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Mensile Stiro" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Tessitura" data-img="./dashboard/images/riso-stat-tessitura.png" runat="server" id="Div63">★</div>
                    </div>
                    <article id="Article17" class="nekaKlasa" data-name="Assenteismo Mensile Tessitura" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Stiro" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-tessitura.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Straordinario Stiro" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=STIRO" data-img="./dashboard/images/riso-stat-stiro.png" runat="server" id="Div30">★</div>
                    </div>
                    <article id="riso_stat_stiro_stra" class="nekaKlasa" data-name="Straordinario Stiro" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=STIRO" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-stiro.png');"></a>
                        <div class="article-lpurple">
                            <h2>
            ...
            <div id="lvl_three_riso_statistiche_struttura" class="animated fadeIn">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Struturra" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=STRUTTURA" data-img="./dashboard/images/riso-stat-stiro.png" runat="server" id="Div34">★</div>
                    </div>
                    <article id="riso_stat_stru_ass" class="nekaKlasa" data-name="Assenteismo Struturra" data-link="./Views/HR/RaportAbsenteDepartament.aspx?Departament=STRUTTURA" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-stiro.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Assenteismo Struturra" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Amministrazione" data-img="./dashboard/images/riso-stat-stiro.png" runat="server" id="Div64">★</div>
                    </div>
                    <article id="Article18" class="nekaKlasa" data-name="Assenteismo Mensile Struturra" data-link="./Views/HR/AssenteismoMensilePerReparto.aspx?Departament=Amministrazione" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-stiro.png');"></a>
                        <div class="article-lpurple">
                            <h2>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Straordinario Struturra" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=STRUTTURA" data-img="./dashboard/images/riso-stat-stiro.png" runat="server" id="Div35">★</div>
                    </div>
                    <article id="riso_stat_stru_stra" class="nekaKlasa" data-name="Straordinario Struturra" data-link="./Views/HR/RaportSuplimentareDepartament.aspx?Departament=STRUTTURA" runat="server">
                        <a href="#!" class="img-container" style="background-image: url('./dashboard/images/riso-stat-stiro.png');"></a>
                        <div class="article-lpurple">
                            <h2>
            ...
            <div id="lvl_two_riso_chat" class="animated j">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xs-3 prior blur" runat="server">
                    <div class="ribbon">
                        <div class="nekaKlasa1" data-name="Busta paga" data-link="./Views/HR/Prezente.aspx" data-img="./dashboard/images/riso-chat-buste.png" runat="server" id="Div11">★</div>
                    </div>
                    <article id="Article5" class="nekaKlasa" data-name="Busta paga" data-link="./Views/HR/Prezente.aspx" runat="server">
        ...
        <div id="right-navi">
            ...
            <div class="user">
                <asp:Image runat="server" ID="small_profile" />
                <span>
