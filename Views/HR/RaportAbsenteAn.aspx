<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RaportAbsenteAn.aspx.cs" Inherits="RaportAbsenteAn" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="hRaportAbsenteAn" runat="server">
...
<body>
    <form id="fRaportAbsenteAn" runat="server" method="post" enctype="multipart/form-data" target="upload_target">
        <asp:ScriptManager ID="smRaportAbsenteAn" runat="server">
            <Services>
                <asp:ServiceReference Path="RaportAbsenteAnWS.asmx" />
            </Services>
            <Scripts>
                <asp:ScriptReference Path="~/Js/RaportAbsenteAn.js" />
                ...
                <td class="principal">
                    <table width="100%">
                        <tr>
                           ...
                           <td align="center">
                                <asp:Label ID="lRaportAbsenteAn" runat="server" CssClass="principal" Text="Analisi straordinario per tipologia (autorizzate)"></asp:Label>
                           </td> 
                           <td>
                            ...
                            <td valign="top">
                                <table id="tAbsenteProcent" width="675" style="border: 1px solid #800080; border-collapse: collapse;">
                                    <tr>
                                        ...
                                        <td class="rSecundLarge" align="center">&nbsp;<asp:Label ID="htRaportAbsentaAn" runat="server" 
