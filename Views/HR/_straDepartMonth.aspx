<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_straDepartMonth.aspx.cs" Inherits="Views_HR_straDepartMonth" %>
                                                         ...
                                                         columns: [
                                                             {
                                                                 alignment: 'right',
                                                                 fontSize: 14,
                                                                 text: 'Straordinario Departament - ' + getUrlParameter('Departament') + ' ' + $('#ddp_month').val() + '/' + $('#ddp_year').val() + '',
                                                                 filename: 'Straordinario Departament - ' + getUrlParameter('Departament') + ' ' + $('#ddp_month').val() + '/' + $('#ddp_year').val() + ''
                                                             }
                                                         ],
                                                         margin: 20
                                                     }
