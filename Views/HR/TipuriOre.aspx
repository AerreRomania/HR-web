<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipuriOre.aspx.cs" Inherits="TipuriOre" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="hTipuriOre" runat="server">
    <title>TipuriOre</title>
    <link href="~/Css/StyleSheet.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="fTipuriOre" runat="server">
        <asp:ScriptManager ID="smTipuriOre" runat="server">
            <Services>
                <asp:ServiceReference Path="TipuriOreWS.asmx" />
            </Services>
            <Scripts>
                <asp:ScriptReference Path="~/Js/TipuriOre.js" />
            ...
            <tr>
                <td class="principal">
                    <table width="100%">
                        <tr>
                           <td>
                                <asp:Label ID="lTipuriOre" runat="server" CssClass="principal" Text="Codice per ore"></asp:Label>
                           </td> 
                           <td align="right">
                    ...
                    <table class="principal">
                        <tr>
                            <td valign="top" style="height: 130px">
                                <table id="tTipuriOre" class="principal" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="secund">&nbsp;<asp:Label ID="htCodTipOra" runat="server" 
                                                Text="Codice per ore"></asp:Label></td>
                                        <td class="secund">&nbsp;<asp:Label ID="htTipOra" runat="server" 
                                                Text="Descrizione"></asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lFiltruCodTipOra" runat="server" CssClass="continut" Text="Codice per ore"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="tbFiltruCodTipOra" runat="server"  Width="120px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lFiltruTipOra" runat="server" CssClass="continut" Text="Descrizione"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="tbFiltruTipOra" runat="server"  Width="120px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td align="right">
                                            <asp:Label ID="lCodTipOra" runat="server" Text="Codice per ore" CssClass="continut"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbCodTipOra" runat="server" Width="70px" ></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            <asp:Label ID="lTipOra" runat="server" Text="Descrizione" CssClass="continut"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbTipOra" runat="server" Width="250px" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
