<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipuriPostDeLucru.aspx.cs" Inherits="TipuriPostDeLucru" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="hTipuriPostDeLucru" runat="server">
    <title>Categoria</title>
    <link href="~/Css/StyleSheet.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="fTipuriPostDeLucru" runat="server">
        <asp:ScriptManager ID="smTipuriPostDeLucru" runat="server">
            <Services>
                <asp:ServiceReference Path="TipuriPostDeLucruWS.asmx" />
            </Services>
            <Scripts>
                <asp:ScriptReference Path="~/Js/TipuriPostDeLucru.js" />
            ...
            <tr>
                <td class="principal">
                    <table width="100%">
                        <tr>
                           <td>
                                <asp:Label ID="lTipuriPostDeLucru" runat="server" CssClass="principal" Text="Categoria"></asp:Label>
                           </td> 
                           <td align="right">
                    ...
                    <table class="principal">
                        <tr>
                            <td valign="top" style="height: 130px">
                                <table id="tTipuriPostDeLucru" class="principal" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="lFiltruTipPostDeLucru" runat="server" CssClass="continut" Text="Categoria" ToolTip="Categoria"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="tbFiltruTipPostDeLucru" runat="server"  Width="120px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td align="right">
                                            <asp:Label ID="lTipPostDeLucru" runat="server" Text="Categoria" CssClass="continut"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="tbTipPostDeLucru" runat="server" Width="250px" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
