<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_assMensileDepartYear.aspx.cs" Inherits="Views_HR_assMensileDepartYear" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <asp:Label runat="server" ID="txt_year" style="display:none;"></asp:Label>
                <asp:Label runat="server" ID="txt_month" style="display:none;"></asp:Label>
                             ...
                             $('.grd thead tr').eq(0).each(function () {
                                 ...
                                 for (i = 6; i <= 38; i++) {
                                     ...
                                     $('.grd tbody tr').each(function () {
                                         total += parseFloat($(this).find('td').eq(i).text()) || 0;
                                     })
                                     $row.find('th').eq(i).append('<span style="display:block"  class="tot"> = ' + parseFloat(total).toFixed(2) + '</span>');
                                 }
                             })
                             ...
                             $('.grd').dataTable({
                                 ...
                                 buttons: [
                                                     ...
                                                     columns: [
                                                         {
                                                             alignment: 'right',
                                                             fontSize: 14,
                                                             text: 'Assenteismo Departament - ' + getUrlParameter('Departament') + ' ' + $('#txt_month').text() + '/' + $('#txt_year').text() + '',
                                                             filename: 'Assenteismo Departament - ' + getUrlParameter('Departament') + ' ' + $('#txt_month').text() + '/' + $('#txt_year').text() + ''
                                                         }
                                                     ],
                                                     margin: 20
                                                 }
                                     ...
                                     },
                                     {
                                         ...
                                         extension: '.xlsx',
                                         filename: 'Assenteismo Departament Mensile- ' + getUrlParameter('Departament') + '',
