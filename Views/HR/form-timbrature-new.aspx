<%@ Page Language="VB" AutoEventWireup="false" CodeFile="form-timbrature-new.aspx.vb" Inherits="Views.HR.form_timbrature_new" %>
                ...
                <table style="margin:0 auto; position:center;margin-top:10px;">
                    ...
                    <tr>
                        <td colspan="8">
                              ...
                              <tr>
                               <%-- <td colspan="8">
                                    <embed src="./form-timbrature.aspx" runat="server" frameborder="0" width="96%" height="400px;" />
                                </td>--%>
                            </tr>
                </table>
