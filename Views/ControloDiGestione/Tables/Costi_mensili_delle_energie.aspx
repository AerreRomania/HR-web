<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Costi_mensili_delle_energie.aspx.cs" Inherits="Views_ControloDiGestione_Tables_Costi_mensili_delle_energie" %>
	...
	<section class="detail">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-12">
						<h1 id="tassi">Costi mensili delle energie</h1>

						<div style="display: inline-block; float: right;">
							<b class="col-sm-12 knitting-title"> <font color="CornflowerBlue">Olimpias Knitting-anno </font></b>
						</div>
					</div>
					</br>
...
<thead>
	<tr>
		...
		<th style="background-color:#f4f4f4; font-weight:bold;font-size:15px; width:65px;border-right: 1px solid #000000;border-bottom:1px solid #D3D3D3;color:red;" colspan="2">Kwh 16</th>
		<th style="background-color:#f4f4f4; font-weight:bold;font-size:15px;width:65px;border-right: 1px solid #000000;border-bottom:1px solid #D3D3D3;" colspan="2">Kwh 17</th>
		<th style="background-color:#f4f4f4; font-weight:bold;font-size:15px;width:65px; border-right: 1px solid #000000;border-bottom:1px solid #D3D3D3;" colspan="2">c.kwh 16</th>
		<th style="background-color:#f4f4f4; font-weight:bold;font-size:15px;width:65px; border-right: 1px solid #000000;border-bottom:1px solid #D3D3D3;" colspan="2">c.kwh 17</th>
		<th style="background-color:#90EE90; font-weight:bold;font-size:15px;width:65px;border-right: 1px solid #000000;border-bottom:1px solid #D3D3D3;" colspan="2">Delta %</th>
										...
										<tbody>
												...
												<tr>
													<td  style="border-right: 1px solid #000000;">hhghghg</td>
													<td>d</td>
												...
												<tr>
													<td style="border-right: 1px solid #000000;border-bottom:1px solid #000000;">hhghghg</td>
												...
												<tr>
													<td style="border-right: 1px solid #000000;border-bottom:1px solid #000000;border-top:1px solid #000000;">hhghghg</td>
