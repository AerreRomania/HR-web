<%@ Page Language="VB" AutoEventWireup="false" CodeFile="~/Views/Produzione/form-angajati.aspx.vb" Inherits="form_angajati" MaintainScrollPositionOnPostback="true"  %>
...
<%--                <div class="span3">
                ...
                <div class="span11">
                    ...
                    <div class="widget-content" style="height: 65vh; overflow: auto">
                        ...
                        Selectcommand="Select [Id], [CodAngajat], [Angajat], [Sex], [DataNasterii], [DataAngajarii], [status], [Linie], [IdSector] From [Angajati] Where IdSector=1 ORDER BY [CodAngajat] DESC"
