<%@ Page Language="VB" AutoEventWireup="false"CodeFile="form-article.aspx.vb" Inherits="form_article" MaintainScrollPositionOnPostback="true"  %>
                 ...
                 <%-- <div class="span4">
                  <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                          ...
                          <div class="controls">
                            <asp:TextBox runat="server" ID="txt_art_name" CssClass="col-xs-8" placeholder="1.20031554E1D"></asp:TextBox>
                          </div>
                        <br />
                        ...
                        <br />
                          ...
                          <div class="controls">
                              <asp:DropDownList runat="server" ID="ddl_Sector" CssClass="col-xs-8">
                                <asp:listitem Value="1">Confezione</asp:listitem>
                              </asp:DropDownList>
                          </div>
                        <br />
                ...
                <div class="span11">
                    ...
                    <div class="widget-content" style="height: 65vh; overflow: auto">
                          ...
                          <asp:sqldatasource id="CustomersSqlDataSourceArticle"  
                            Selectcommand="Select [Id], [Articol], [Descriere], [CostProductie], [IdStagiune], [Finete], [Prezzo], [IdSector], [Centes], [Stagione] From [Articole] Where IdSector = 1"
