<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_articles.aspx.cs" Inherits="Views_Produzione_articles" %>
      ...
      <asp:UpdatePanel runat="server">
          <ContentTemplate>
           ...
           <%-- <div id="content-header">
              <h1>Article view - <asp:Label runat="server" ID="txt_dep"></asp:Label></h1>
            </div>--%>
                ...
                <div class="span11">
                    <div class="widget-box">
                      <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        <h5>Active Articles in <asp:Label runat="server" ID="txt_dep" style="font-size: 15pt;"></asp:Label></h5>
                      </div>
