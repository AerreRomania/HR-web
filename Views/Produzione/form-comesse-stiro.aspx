<%@ Page Language="VB" AutoEventWireup="false" CodeFile="form-comesse-stiro.aspx.vb" Inherits="form_comesse_stiro" %>
...
INNER JOIN Clienti ON Comenzi.IdClient = Clienti.Id WHERE Comenzi.IdSector='2'"
