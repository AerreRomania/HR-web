<%@ Page Language="C#" AutoEventWireup="true" CodeFile="_commesse.aspx.cs" Inherits="Views_Produzione_commesse" %>
                ...
                <div class="span11">
                    <div class="widget-box">
                      <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        <h5>Active Commesse in <asp:Label runat="server" ID="txt_dep" style="font-size: 15pt;"></asp:Label></h5>
                      </div>
