<%@ Page Language="VB" AutoEventWireup="false" CodeFile="form-tabletserials-stiro.aspx.vb" Inherits="form_tabletserials" %>
                                ...
                                <div class="widget-box">
                                    ...
                                    <div class="widget-content" style="height: 84vh; overflow: auto">
                                        ...
                                        <asp:SqlDataSource ID="CustomersSqlDataSourceTabletSerials"
                                            SelectCommand="Select * From TabletInformations WHERE Line IN ('S1','S2','S3','S4','S5','S6') ORDER BY Line, FullName ASC"
